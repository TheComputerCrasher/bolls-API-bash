...
* Maybe get [full translations](https://github.com/Bolls-Bible/bain/blob/master/docs/API.md#get-a-full-translation) and cache them locally if getting more than one chapter at a time
